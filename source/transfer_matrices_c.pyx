...
def init_arrays():
    ...
    Z_BETA065 = np.linspace(0., L_CAV_BETA065, N_POINTS_BETA065 + 1)


cpdef DTYPE_t interp(DTYPE_t z, DTYPE_t[:] z_array, DTYPE_t[:] e_z_array):
    return np.interp(z, z_array, e_z_array, left=0., right=0.)
