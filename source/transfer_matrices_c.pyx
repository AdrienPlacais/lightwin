...
cpdef init_arrays():
    ...
    d_ez1 = {"e_z": E_Z_SIMPLE_SPOKE, "n_points": N_POINTS_SIMPLE_SPOKE,
             "inv_dz": INV_DZ_SIMPLE_SPOKE}
    d_ez2 = {"e_z": E_Z_SPOKE_ESS, "n_points": N_POINTS_SPOKE_ESS,
             "inv_dz": INV_DZ_SPOKE_ESS}
    d_ez3 = {"e_z": E_Z_BETA065, "n_points": N_POINTS_BETA065,
             "inv_dz": INV_DZ_BETA065}
    l_d_ez = [d_ez1, d_ez2, d_ez3]
