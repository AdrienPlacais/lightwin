...
print(
    f"delta_phi: {ref_linac.synch.phi['abs_array'][-1]-ref_values[0]}\t",
    f"delta_W: {ref_linac.synch.energy['kin_array_mev'][-1]-ref_values[1]}\t",
    f"delta_MT: {np.sum(ref_linac.transf_mat['cumul'][-1]-ref_values[2])}"
)
